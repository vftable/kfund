...
bool _offsets_init(void) {
    if (SYSTEM_VERSION_EQUAL_TO(@"16.1") || SYSTEM_VERSION_EQUAL_TO(@"16.1.1") || SYSTEM_VERSION_EQUAL_TO(@"16.1.2") || SYSTEM_VERSION_EQUAL_TO(@"16.2")) {
        printf("[i] offsets selected for iOS 16.1.x - 16.2\n");
